...
import { GET_COUNTRIES, GET_COUNTRIES_BY_REGION, GET_COUNTRY_BY_NAME, GET_COUNTRIES_BY_NAME, SET_LOADING } from '../type';
...
export const getCountriesByName = (name) => async dispatch => {
    ...
    await axios.get(`${countriesApi}/name/${name}`)
        ...
        .catch((err) => console.log('Get countries by name api error:', err))
}